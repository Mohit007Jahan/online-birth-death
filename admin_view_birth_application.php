...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['status'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO status_logs (application_id, admin_id, old_status, new_status, remark, application_type) 
                               SELECT ?, ?, status, ?, ?, 'birth' FROM tblbirthapplications WHERE id = ?");
...
try {
    ...
    error_log("Fetching birth application with ID: " . $id);
    
    // First verify if the application exists
    $stmt = $conn->prepare("SELECT COUNT(*) FROM tblbirthapplications WHERE id = ?");
    $stmt->execute([$id]);
    ...
    error_log("Database error in admin_view_birth_application.php: " . $e->getMessage());
    error_log("Stack trace: " . $e->getTraceAsString());
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <div class="back-button">
                <a href="admin_view_birth1.php" class="btn btn-secondary">
        ...
        <?php if (isset($application)): ?>
            <div class="card">
                <div class="card-header">
                        <h3 class="mb-0">Birth Application Details</h3>
                    </div>
                <div class="card-body">
                    <!-- Application Details -->
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div>
                                    <a href="edit_birth_application.php?id=<?php echo $application['id']; ?>" class="btn btn-primary">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <h4 class="mb-3">Update Application Status</h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>Order of Child:</th>
                                    <td><?php echo htmlspecialchars($application['order_of_child']); ?></td>
                                </tr>
                                <tr>
                                    <th>Nationality:</th>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($application['permanent_address']); ?></td>
                                </tr>
                            </table>
                    </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($application['hospital_paper'])): ?>
                                                    <a href="download.php?file=<?php echo urlencode($application['hospital_paper']); ?>&type=hospital" 
                                                       class="btn btn-sm btn-info" target="_blank">
                                                        <i class="fas fa-file-medical"></i> View Document
                                                    </a>
                                                    <small class="text-muted ms-2"><?php echo htmlspecialchars(basename($application['hospital_paper'])); ?></small>
                                                <?php else: ?>
