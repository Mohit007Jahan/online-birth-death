...
try {
    // Get all death certificate applications for the current user
    $stmt = $conn->prepare("
        SELECT * FROM tbldeathapplications 
        WHERE user_id = ? 
    ...
    error_log("Error fetching death applications: " . $e->getMessage());
...
<head>
    ...
    <title>Added Death Certificates</title>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="user_added_death.php" class="active">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($app['status'] === 'Approved'): ?>
                                                <a href="user_certi_death.php?id=<?php echo $app['id']; ?>" class="view-btn">View Certificate</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
