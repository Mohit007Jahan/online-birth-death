...
<head>
    ...
    <title>Register New Death Certificate</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            <form action="user_application_death2.php" method="POST">
            <h3>Relationship with you-</h3>
                <div class="relationship-options">
                    <label><input type="radio" name="relationship" value="grandfather" required> Grandfather</label>
                    <label><input type="radio" name="relationship" value="grandmother" required> Grandmother</label>
                    ...
                    <label><input type="radio" name="relationship" value="brother" required> Brother</label>
                    <label><input type="radio" name="relationship" value="sister" required> Sister</label>
                    <label><input type="radio" name="relationship" value="spouse" required> Spouse</label>
                    <label><input type="radio" name="relationship" value="son" required> Son</label>
                    <label><input type="radio" name="relationship" value="daughter" required> Daughter</label>
                </div>

                <div class="aliveness-check">
                    <h3>We are sorry for your lost</h3>
                    <img src="face authentication.png" alt="Check Aliveness"> <!-- Replace with actual image path -->
                    <button type="submit" class="btn-ready">Yes, I'm ready to proceed!</button>
                    <p class="instructions">Click the button if you are ready to continue.</p>
                </div>
            </form>
        </div>
    </div>
