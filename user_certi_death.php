...
try {
    ...
    $stmt = $conn->prepare("
        SELECT d.*, u.FirstName, u.LastName, u.Email, u.MobileNumber 
        FROM tbldeathapplications d
        JOIN tbluser u ON d.user_id = u.ID
        WHERE (d.id = ? OR d.ID = ? OR d.Id = ?) AND d.user_id = ?
    ");
    ...
    $dod = new DateTime($cert['date_of_death']);
    $dodInWords = $dod->format('jS M, Y');
    ...
    error_log("Error fetching death certificate: " . $e->getMessage());
    header("Location: user_added_death.php");
    exit();
}
?>
...
<body>
    ...
    <div class="content-wrapper">
            ...
            <div class="certificate-content">
                ...
                <div class="info-grid">
                    <div class="left-column">
                        ...
                        <div class="info-item">
                            <strong>Death Register No:</strong>
                            <span class="info-value"><?php echo htmlspecialchars($cert['registration_no']); ?></span>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo date('d/m/Y', strtotime($cert['date_of_death'])); ?></span>
                        </div>
                        <div class="info-item">
                            <strong>In Word:</strong>
                            <span class="info-value"><?php echo $dodInWords; ?></span>
                </div>
                        <div class="info-item">
                            <strong>Place of Death:</strong>
                            <span class="info-value"><?php echo htmlspecialchars($cert['place_of_death']); ?></span>
                </div>
                    </div>
                    ...
                    <div class="right-column">
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo htmlspecialchars($cert['age_at_death']); ?> Years</span>
                        </div>
                        <div class="info-item">
                            <strong>Cause of Death:</strong>
                            <span class="info-value"><?php echo htmlspecialchars($cert['cause_of_death']); ?></span>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo htmlspecialchars($cert['nid_number']); ?></span>
                        </div>
                        <div class="info-item">
        ...
        <div class="actions-container">
            ...
            <button class="action-btn exit-btn" onclick="window.location.href='user_added_death.php'">Exit Page</button>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            var qrData = "Register No: <?php echo $cert['registration_no']; ?>, Name: <?php echo $cert['name']; ?>, Date of Death: <?php echo date('d/m/Y', strtotime($cert['date_of_death'])); ?>";
            $('#qrcode').qrcode({
                text: qrData,
                width: 100,
                height: 100
